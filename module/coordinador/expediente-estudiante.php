...
<body>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="observaciones-documentos.php" class="btn btn-warning btn-sm naranja m-2 col-11 sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Comentario de Resultados</strong> </small></a>
                                </div>
    ...
    <div class="modal fade" id="modalMensajeCorreo" tabindex="-1" role="dialog" aria-labelledby="modalMensajeCorreoLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalMensajeCorreoLabel">Agregar mensaje al correo</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="mensajePersonalizado">Mensaje adicional (opcional):</label>
                        <textarea class="form-control" id="mensajePersonalizado" rows="5" placeholder="Escribe aquí tu mensaje personalizado para el estudiante..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
